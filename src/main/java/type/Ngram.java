...
/* First created by JCasGen Sun Sep 20 23:25:36 EDT 2015 */
package type;
...
public class Ngram extends ComponentAnnotation {
  ...
  */  
  ...
  /** getter for text - gets join all tokens in hthis n-gram into a string
   * @generated
   * @return value of the feature 
   */
  public String getText() {
    if (Ngram_Type.featOkTst && ((Ngram_Type)jcasType).casFeat_text == null)
      jcasType.jcas.throwFeatMissing("text", "type.Ngram");
    return jcasType.ll_cas.ll_getStringValue(addr, ((Ngram_Type)jcasType).casFeatCode_text);}
    
  /** setter for text - sets join all tokens in hthis n-gram into a string 
   * @generated
   * @param v value to set into the feature 
   */
